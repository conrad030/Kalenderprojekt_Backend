...
ADD
  FOREIGN KEY (userId) REFERENCES SmartCalendar.User(id) ON DELETE CASCADE,
ADD
  FOREIGN KEY (appointmentId) REFERENCES SmartCalendar.Appointment(id) ON DELETE CASCADE;
